...
def rate():
    ...
    # Storing variables taken from form data and formatting it as a row to be entered into the dataset
...
def upload():
    ...
    # Creating an array of the target users highet rated movies
